...
public class StreamReaderDemo01 {
    public static void main(String[] args) {
        try (
                ...
                InputStream inputStream = new FileInputStream("java-io-demo/src/main/java/com/demo/abc-gbk.txt");
                Reader inputStreamReader = new InputStreamReader(inputStream, "GBK");
                BufferedReader bufferedReader = new BufferedReader(inputStreamReader);
                // 字节输出流 -> 字符输出转换流 -> 字符输出缓冲流
                OutputStream outputStream = new FileOutputStream("java-io-demo/src/main/java/com/demo/abc-gbk.txt", true);
