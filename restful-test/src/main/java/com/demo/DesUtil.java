...
public class DesUtil {
     ...
     *
     * @param key  公钥
     * @param localTime 时间作为公钥，格式为yyyyMMddHHmmss
     * @param secret 私钥
     * @return
     */
    public static String getCheckNo(String key,String localTime,String secret){
        //集成商身份验证码 格式 集成商校验码+系统时间（20191015090101） 通过DES加密 秘钥1,2为公钥，秘钥3为私钥 与集成商校验码线下约定
        String checkNo = desEncode(key +  localTime,
                "jsdl", "frontier", secret);
        return checkNo;
    }
     ...
     * @see [类、类#方法、类#成员]
     */
    public static String desEncode(String data, String firstKey, String secondKey, String thirdKey) {
        ...
        if (leng > 0) {
            boolean b = firstKey != null && firstKey != "" && secondKey != null && secondKey != "" && thirdKey != null
                    && thirdKey != "";
            if (leng < 4) {
                int[] bt = strToBt(data);
                int[] encByte = null;
     ...
     * @see [类、类#方法、类#成员]
     */
    public static String desDecode(String data, String firstKey, String secondKey, String thirdKey) {
        int leng = data.length();
        String decStr = "";
        List<?> firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
        int firstLength = 0, secondLength = 0, thirdLength = 0;
